...
export type ServerOptions = ProtocolOptions & {
     ...
     *
     * @default {@linkcode DefaultJsonSchemaValidator} ({@linkcode AjvJsonSchemaValidator} on Node.js, {@linkcode CfWorkerJsonSchemaValidator} on Cloudflare Workers)
     */
 ...
 *
 * @deprecated Use {@linkcode McpServer} instead for the high-level API. Only use `Server` for advanced use cases.
 */
